...
export function createVantaCli(dependencies = {}) {
    ...
    tests
        ...
        const service = dependencies.service ?? createService(program, dependencies.fetchFn);
...
function createService(program, fetchFn) {
    ...
    return createVantaTestService(new VantaApiClient(config, createOAuthAccessTokenProvider(config, fetchFn), fetchFn));
}
